import { Box, Typography, Table, TableBody, TableRow, TableCell, styled, Divider } from '@mui/material';
...
const ProductDetail = ({product,fassured,title,cost,mrp,discount,description}) => {
    ...
    <Typography>
        <span style={{ fontSize: 28 }}>₹{cost}</span>&nbsp;&nbsp;&nbsp; 
                ...
                <TableBody>
                    ...
                    <ColumnText>
                        ...
                        <TableCell>
                            ...
                            <Typography>View more sellers starting from ₹{cost}</Typography>
                        </TableCell>
                    </ColumnText>
